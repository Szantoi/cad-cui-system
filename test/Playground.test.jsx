...
describe('interactive CAD CUI playground', () => {
  ...
  it('keeps header workspace controls outside the menubar and exposes direct plus explicit dock actions', () => {
    ...
    const header = document.querySelector('.cad-demo-header');
    const headerChildren = [...header.children];
    const brand = screen.getByText('CAD CUI').closest('.cad-demo-header__brand');
    const status = screen.getByText('ENGINE:').closest('.cad-demo-header__status');
  ...
  it('distinguishes, moves, collapses, and restores the viewport selection and command-console overlays', async () => {
    ...
    [[navigationOverlay, '⌖'], [selectionOverlay, '▣'], [dynamicOverlay, '>_']].forEach(([overlay, icon]) => {
