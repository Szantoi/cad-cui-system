...
import { CadCuiCommandPalette, CadCuiContextMenu, CadCuiCustomizer, CadCuiProvider, CadCuiQuickAccess, CadCuiRibbon, defineCadCuiSystem, loadCadCuiState, sanitizeCadCuiState, selectCadCuiCommandGroups, selectCadCuiCommands, useCadCui } from '../src/index.js';
...
function GroupedFixture({ commandStates = {}, handlers = {} }) {
...
function renderGroupedFixture(options) {
  return render(<MemoryRouter initialEntries={['/graph']}>
