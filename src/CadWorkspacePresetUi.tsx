 ...
 */
export function normalizeCadWorkspacePresets(value: readonly any[] = []) {
...
export function isCadWorkspacePresetNameTaken(value: readonly any[] = [], name: any, { exceptId }: CadAnyProps = {}) {
