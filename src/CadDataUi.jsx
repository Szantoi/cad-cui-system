...
import { CadPropertyGrid } from './CadInspectorUi.jsx';
...
export function CadSelectionFilter({ filters = [], activeIds, defaultActiveIds = [], onChange, label = 'Selection filter', className, ...props }) {
...
export function CadQuickProperties({ title = 'Quick properties', properties, sections, onValueChange, onPinChange, pinned = false, onClose, className, ...props }) {
