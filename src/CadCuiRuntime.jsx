...
const CadCuiContext = createContext(null);
 ...
 */
export function defineCadCuiSystem(definition = EMPTY_OBJECT) {
...
export function loadCadCuiState(system, storage = typeof window === 'undefined' ? null : window.localStorage) {
...
export function saveCadCuiState(system, state, storage = typeof window === 'undefined' ? null : window.localStorage) {
...
export function useCadCuiCommand(commandId, source = 'api') {
  const { executeCommand } = useCadCui();
  return useCallback(payload => executeCommand(commandId, { source, payload }), [commandId, executeCommand, source]);
}
...
export function CadCuiContextMenu({ menuId = 'canvas', iconMap = EMPTY_OBJECT, className, onClose, ...props }) {
...
export function CadCuiCommandPalette({ iconMap = EMPTY_OBJECT, className, ...props }) {
...
export function CadCuiCustomizer({ className, ...props }) {
