...
const visibleGroups = ({ groups, commands, activeTabId, defaultGroupId, defaultGroupLabel }: CadAnyProps) => {
...
function CadWorkspaceRibbonTool({ command, group, activeTab, compact, renderIcon, renderCommand, onCommand }: CadAnyProps) {
...
export function CadWorkspaceRibbon({
  ...
  const closeMinimizedFlyout = ({ restoreTabFocus = false }: CadAnyProps = {}) => {
    setFlyoutOpen(false);
