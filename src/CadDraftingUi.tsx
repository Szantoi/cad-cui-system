...
import { CadAngleInput, CadNumericInput, CadShortcutHint, CadToolButton, CadUnitInput } from './CadCommandUi';
 ...
 */
export function CadDynamicInput({ mode = 'point', fields, value, defaultValue = {}, onChange, onSubmit, prompt = 'Specify point', unit = 'mm', visible = true, submitLabel = 'Accept', className, children, ...props }: CadAnyProps) {
...
export function CadObjectSnapMenu({ modes = DEFAULT_SNAP_MODES, activeIds, defaultActiveIds = [], multiple = true, onChange, onClose, label = 'Object snaps', className, ...props }: CadAnyProps) {
 ...
 */
export function CadConstraintBar({ constraints = DEFAULT_CONSTRAINTS, activeIds, defaultActiveIds = [], onChange, onAction, label = 'Geometric constraints', layout = 'strip', className, ...props }: CadAnyProps) {
...
export function CadAnnotationScalePicker({ scales = DEFAULT_SCALES, value, defaultValue, onChange, label = 'Annotation scale', onManage, id, selectProps = {}, disabled = false, layout = 'stacked', className, ...props }: CadAnyProps) {
  const generatedId = useId();
...
export function CadViewPresetPicker({ presets = DEFAULT_VIEWS, value, defaultValue, onChange, label = 'View preset', id, selectProps = {}, disabled = false, className, ...props }: CadAnyProps) {
  const generatedId = useId();
...
export function CadPolarTracker({ angle, distance, increment, active, defaultActive = false, onActiveChange, className, label = 'Polar tracking', ...props }: CadAnyProps) {
...
export function CadObjectSnapMarker({ type = 'endpoint', label, active = true, className, style, ...props }: CadAnyProps) {
...
export function CadSelectionGrip({ label = 'Selection grip', variant = 'square', active = false, disabled = false, onPointerDown, onClick, className, ...props }: CadAnyProps) {
