...
import { cx, useControllableState } from './cadUiUtils.js';
 ...
 * application shell.
 */
export function useCadWorkspaceFocus({ active, defaultActive = false, onActiveChange } = {}) {
 ...
 */
export const CadWorkspaceFocusToggle = forwardRef(function CadWorkspaceFocusToggle({
  active,
  defaultActive = false,
  onActiveChange,
